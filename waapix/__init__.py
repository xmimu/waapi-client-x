...
from waapi import WaapiClient, SequentialThreadExecutor
from waapix.contains.uri import *


class WaapiClientX(WaapiClient):

    def __init__(self, url=None, allow_exception=False, callback_executor=SequentialThreadExecutor):
